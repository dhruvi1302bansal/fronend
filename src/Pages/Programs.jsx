...
//           <Link to="/Assessments" className="px-8 py-3 bg-[#F1F3EB] text-[#2F3E28] font-bold rounded-sm hover:bg-white transition-colors hover:shadow-md hover:scale-105 hover:border-2 hover:border-[#D4AF37] hover:text-[#2F3E28] hover:shadow-white">
//             Take Free Quiz
//           </Link>
//           <Link to="/Consulation" className=" bg-[#BAB86C]  px-8 py-3 border-2 border-[#D4AF37] text-[] font-bold rounded-sm hover:bg-[#D4AF37] hover:text-[#2F3E28] transition-colors hover:shadow-md hover:scale-105 hover:shadow-white ">
//             Talk to an Expert
//           </Link>
//         </div>
//       </section>
...
const Programs = () => {
  ...
  return (
    <div className="bg-[#F5F5DC] min-h-screen">
      ...
      {/* --- HERO SECTION (UPDATED: Bamboo Texture) --- */}
      <section className="relative py-20 md:py-28 px-6 overflow-hidden">
        {/* Bamboo Background Image */}
        <div className="absolute inset-0 z-0">
          <img 
            // src="https://images.unsplash.com/photo-1567648280901-32b865283948?q=80&w=2000&auto=format&fit=crop" 
            src="https://plus.unsplash.com/premium_photo-1679431044148-0cbef977e7d3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8c2VsZiUyMGNhcmV8ZW58MHx8MHx8fDA%3D"
            alt="Bamboo Leaves Texture" 
            className="w-full h-full object-cover"
          />
          {/* Dark Green Overlay to ensure text readability */}
          <div className="absolute inset-0 bg-[#2F3E28]/85 mix-blend-multiply"></div>
        </div>

        <div className="max-w-7xl mx-auto text-center z-10 relative">
          <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/50 text-[#D4AF37] text-sm font-medium mb-6 tracking-wide backdrop-blur-sm">
            <Leaf size={16} /> Ayurvedic Excellence
          </div>
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-[#F1F3EB]">
            Healing Programs
          </h1>
      ...
      {/* --- BOTTOM BANNER (UPDATED: Sand Powder Texture) --- */}
      <section className="relative py-16 text-center px-6 overflow-hidden">
        
        {/* Sand Powder Background */}
        <div className="absolute inset-0 z-0">
          <img 
            // src="https://images.unsplash.com/photo-1604628848823-d2740909d79e?q=80&w=2000&auto=format&fit=crop" 
            src="https://images.unsplash.com/photo-1647018763651-e32158974419?w=600&auto=format&fit=crop"
            alt="Sand Powder Texture" 
            className="w-full h-full object-cover"
          />
          {/* Warm Earthy Overlay */}
          <div className="absolute inset-0 bg-[#BA9D8A]/80 mix-blend-multiply"></div>
        </div>

        {/* Content */}
        <div className="relative z-10">
          <h2 className="text-3xl font-serif text-white mb-4 drop-shadow-md">Not sure which program fits you?</h2>
          <p className="text-[#3E2723] mb-8 max-w-2xl mx-auto font-bold drop-shadow-sm text-lg">
            Take our free AI-powered Dosha Quiz or speak to a health counselor to find your path to wellness.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/Assessments" className="px-8 py-3 bg-[#F1F3EB] text-[#2F3E28] font-bold rounded-sm hover:bg-white transition-colors hover:shadow-md hover:scale-105 hover:border-2 hover:border-[#D4AF37] hover:text-[#2F3E28] hover:shadow-white">
