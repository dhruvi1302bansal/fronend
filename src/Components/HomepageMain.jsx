...
const HomepageMain = () => {
  return (
            ...
            <div className="font-sans text-gray-800 selection:bg-vedara-clay selection:text-white">
      {/* --- Hero Section --- */}
      <section className="relative pt-20 lg:pt-0 min-h-[90vh] flex items-center bg-vedara-sand overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="z-10 order-2 lg:order-1 py-12 lg:py-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
  <button className="bg-[#F5F5DC] hover:bg-[#808000] text-gray-800 hover:text-white px-8 py-4 rounded-md font-bold text-lg transition duration-300 shadow-lg hover:shadow-xl">
    Book 1:1 Consultation
  </button>
</div>
      ...
      {/* --- Quick Assessment (The Bridge) --- */}
{/* <section className="bg-[#556B2F] text-white py-12 relative overflow-hidden shadow-inner">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="md:w-2/3">
        ...
        <p className="text-stone-100 text-lg font-medium leading-relaxed max-w-2xl">
          You are unique. Your healthcare should be too. Take our 3-minute Prakriti analysis to discover your inner constitution.
        </p>
      </div>

      <div className="md:w-1/3 flex justify-center md:justify-end">
        <button className="bg-[#F5F5DC] hover:bg-white text-[#556B2F] hover:text-[#3e4f21] px-8 py-3 rounded-md font-bold text-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-2xl border-2 border-[#F5F5DC]">
          Take Quick Assessment
        </button>
      </div>
...
{/* --- Quick Assessment (The Bridge) --- */}
      <section className="w-full bg-[#556B2F] text-white py-12 relative overflow-hidden shadow-inner">
        ...
        {/* Inner container set to w-full instead of max-w-7xl */}
